...
from models.keras_ssd300_not_BN import ssd_300
...
load_opts = 0 # 0: from scratch; 1: from pretrained weights; 2: from pretrained model
if load_opts == 0 or load_opts == 1:
    if load_opts == 1:
        # 2: Load some weights into the model.
        ###########################################################################################
        # TODO: Set the path to the weights you want to load.
        weights_path = 'output/ssd300_Not_BN/snapshots/weights/ssd300_pascal_07+12_epoch-30_loss-14.7925_val_loss-14.6434.h5'
    ...
    print("Unknown load_opts. Expected 0 (From scratch),1 (From pretrained weights), 2 (From pretrained model), but got {}".format(load_opts))
...
model_checkpoint = ModelCheckpoint(filepath='output/ssd300_not_BN/snapshots/models/ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='output/ssd300_not_BN/logs/ssd300_pascal_07+12_training_log.csv',
                       separator=',',
                       append=True)
