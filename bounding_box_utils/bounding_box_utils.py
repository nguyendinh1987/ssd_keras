...
def iou_V1(boxes1, boxes2, coords='centroids', mode='outer_product', border_pixels='half', iou_type="tradition"):
    ...
    Arguments:
        ...
        border_pixels (str, optional): How to treat the border pixels of the bounding boxes.
            ...
            If 'half', then one of each of the two horizontal and vertical borders belong
            to the boxex, but not the other.
        iou_type (str, optional): Can be one of "traditional", "per_box1" and "per_box2". With the option "tradition",
            iou is calculated over area of union of two boxes. With the option "per_box1" and "per_box2", iou is calculated over area
            of box 1 and box 2 only, respectively.
