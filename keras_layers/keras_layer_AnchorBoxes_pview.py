...
class AnchorBoxes_Pview(Layer):
    ...
    def __init__(self,
        ...
        super(AnchorBoxes_Pview, self).__init__(**kwargs)

    def build(self, input_shape):
        self.input_spec = [InputSpec(shape=input_shape)]
        super(AnchorBoxes_Pview, self).build(input_shape)
    ...
    def call(self, x, mask=None):
        ...
        #####################################################################################################
        # Dinh: The difference between AnchorBoxes_pview and AnchorBoxes is the method to calculate cx,cy
        #####################################################################################################
        ## --> original
        ...
        ## --> pview
        cy = offset_height + np.array(range(feature_map_height))*step_height
        cx = offset_width +  np.array(range(feature_map_width))*step_width
        ######################################################################################################
        ######################################################################################################
    ...
    def get_config(self):
        ...
        base_config = super(AnchorBoxes_Pview, self).get_config()
