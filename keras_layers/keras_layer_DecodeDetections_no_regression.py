...
class DecodeDetections_no_regresion(DecodeDetections):
    '''
    A Keras layer to decode the raw SSD prediction output. 
    It is inheritated from DecodeDetections Layer and modified refined anchorboxes by original anchorboxes.

    Input shape:
        3D tensor of shape `(batch_size, n_boxes, n_classes + 12)`.

    Output shape:
        3D tensor of shape `(batch_size, top_k, 6)`. [class,conf,4 anchor indices]
    '''
    ...
    def __init__(self,
        ...
        super(DecodeDetections_no_regresion, self).__init__(**kwargs)

    def build(self, input_shape):
        super(DecodeDetections_no_regresion, self).build(input_shape)
    ...
    def call(self, y_pred, mask=None):
        ...
        Returns:
            ...
            `[class_id, confidence, anchorbox_xmin, anchorbox_ymin, anchorbox_xmax, anchorbox_ymax]`.
        '''
        ...
        cx = y_pred[...,-8] # cx = cx_anchor
        cy = y_pred[...,-7] # cy = cy_anchor
        w = y_pred[...,-6] # w = w_anchor
        h = y_pred[...,-5] # h = h_anchor
