...
def ssd_300_pview(image_size,
            ...
            #TODO: need to change aspect_ratios_per_layer. In my idea, there is only one aspect ratio as 1
    ...
    conv7_2 = Conv2D(512, (2, 2), strides=(2, 2), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7_2')(conv7_1)
    #pview = 234x234
    ...
    if net_opt == 0: # seperated classifiers and regressors for different deep level features
        ...
        conv4_3_mbox_priorbox = AnchorBoxes(img_height, img_width, this_scale=scales[0], next_scale=scales[1], aspect_ratios=aspect_ratios[0],
        ...
        conv5_3_mbox_priorbox = AnchorBoxes(img_height, img_width, this_scale=scales[1], next_scale=scales[2], aspect_ratios=aspect_ratios[1],
        ...
        conv6_1_mbox_priorbox = AnchorBoxes(img_height, img_width, this_scale=scales[2], next_scale=scales[3], aspect_ratios=aspect_ratios[2],
